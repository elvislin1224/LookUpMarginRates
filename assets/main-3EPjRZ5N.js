var S=Object.defineProperty;var I=(t,e,n)=>e in t?S(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var w=(t,e,n)=>I(t,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();function v(t,e="stock"){return e==="etf"?1e3:t&&t.includes("小型")?100:2e3}async function b(){try{console.log("[DataLoader] 嘗試載入本地資料: /margin_data.json");const t=await fetch("/margin_data.json");if(!t.ok)throw new Error(`HTTP ${t.status}: ${t.statusText}`);const e=await t.json();if(!e.futures||!Array.isArray(e.futures))throw new Error("資料格式錯誤：缺少 futures 陣列");return console.log(`[DataLoader] ✓ 本地資料載入成功：${e.total_count} 筆`),console.log(`[DataLoader] 資料日期：${e.data_date}`),console.log(`[DataLoader] 最後更新：${e.last_updated}`),e}catch(t){return console.error("[DataLoader] ✗ 本地資料載入失敗:",t),null}}function M(t,e=24){try{const n=new Date(t).getTime(),o=(new Date().getTime()-n)/(1e3*60*60),r=o<e;return console.log(`[DataLoader] 資料新鮮度檢查：${o.toFixed(1)} 小時 (${r?"有效":"已過期"})`),r}catch(n){return console.error("[DataLoader] 資料新鮮度檢查失敗:",n),!1}}function B(t){return t.map(e=>((!e.lotSize||e.lotSize===0)&&(e.lotSize=v(e.contractName,e.type)),e))}function T(t,e,n=50){var r;if(!e||e.trim()==="")return[];const a=e.toLowerCase().trim(),o=[];for(const c of t){let s=0;c.stockCode.toLowerCase()===a?s=100:c.stockCode.toLowerCase().startsWith(a)?s=80:c.stockCode.toLowerCase().includes(a)?s=60:c.contractName.toLowerCase().includes(a)?s=40:(r=c.stockName)!=null&&r.toLowerCase().includes(a)&&(s=30),s>0&&o.push({item:c,relevance:s})}return o.sort((c,s)=>s.relevance-c.relevance).slice(0,n)}function N(t,e){return t.find(n=>n.stockCode===e)}function h(t,e,n){let a=0,o=0,r=0;if(t.type==="stock"){const c=n*t.lotSize*e;a=c*(t.clearingRate??0),o=c*(t.maintenanceRate??0),r=c*(t.initialRate??0)}else t.type==="etf"&&(a=n*(t.clearingFixed??0),o=n*(t.maintenanceFixed??0),r=n*(t.initialFixed??0));return{contractCode:t.contractCode,contractName:t.contractName,stockCode:t.stockCode,lotSize:t.lotSize,price:e,lots:n,clearingMargin:Math.round(a),maintenanceMargin:Math.round(o),initialMargin:Math.round(r)}}function k(t){const e=t.reduce((o,r)=>o+r.clearingMargin,0),n=t.reduce((o,r)=>o+r.maintenanceMargin,0),a=t.reduce((o,r)=>o+r.initialMargin,0);return{totalClearing:Math.round(e),totalMaintenance:Math.round(n),totalInitial:Math.round(a),itemCount:t.length}}function i(t){return Math.round(t).toLocaleString("zh-TW")}function m(t){return`${(t*100).toFixed(2)}%`}function D(t,e){let n=null;return function(...a){const o=this;n&&clearTimeout(n),n=setTimeout(()=>{t.apply(o,a)},e)}}class z{constructor(){w(this,"container",null);this.ensureContainer()}ensureContainer(){let e=document.getElementById("toast-container");e||(e=document.createElement("div"),e.id="toast-container",e.style.cssText=`
  ...
  `).join(""),e.classList.add("show"),e.querySelectorAll(".dropdown-item").forEach(n=>{n.addEventListener("click",a=>{const o=a.currentTarget.dataset.code,r=t.find(c=>c.contractCode===o);r&&(E(r),g())})})}}function g(){const t=document.getElementById("search-dropdown");t&&t.classList.remove("show")}function E(t){console.log(`[Select] 選擇: ${t.contractName}`),p=t;const e=document.getElementById("search-input");e&&(e.value=t.contractName),q(t);const n=document.querySelector(".result-placeholder"),a=document.querySelector(".result-content");n&&(n.style.display="none"),a&&(a.style.display="block")}function q(t){const e=document.getElementById("result-type-badge");e&&(t.contractName.includes("小型")?(e.textContent="小型期貨",e.className="result-type-badge small"):t.type==="etf"?(e.textContent="ETF 期貨",e.className="result-type-badge etf"):(e.textContent="一般股票期貨",e.className="result-type-badge stock"));const n=document.getElementById("result-contract-name");n&&(n.textContent=t.contractName);const a=document.getElementById("result-contract-sub");a&&(a.textContent=`代碼：${t.stockCode}`);const o=document.getElementById("result-lot-size");o&&(o.textContent=t.lotSize.toString()),t.type==="stock"?(document.getElementById("result-clearing").textContent=m(t.clearingRate||0),document.getElementById("result-maintenance").textContent=m(t.maintenanceRate||0),document.getElementById("result-initial").textContent=m(t.initialRate||0)):(document.getElementById("result-clearing").textContent=`$${i(t.clearingFixed||0)}`,document.getElementById("result-maintenance").textContent=`$${i(t.maintenanceFixed||0)}`,document.getElementById("result-initial").textContent=`$${i(t.initialFixed||0)}`)}function O(){if(!p){u.show("請先搜尋並選擇期貨","error");return}if(l.length>=10){u.show("最多只能同時計算 10 個合約","error");return}const t=h(p,0,1);l.push(t),y(),$(),u.show(`已加入：${p.contractName}`,"success")}function H(){const t=document.querySelector(".calc-table tbody");t&&(t.innerHTML=Array(10).fill(0).map((e,n)=>`
  ...
  `).join(""))}function y(){const t=document.querySelector(".calc-table tbody");t&&(t.innerHTML=Array(10).fill(0).map((e,n)=>{const a=l[n];return a?`
    ...
    `:`
      ...
      `}).join(""))}function $(){if(l.length===0){document.getElementById("sum-clearing").textContent="$0",document.getElementById("sum-maintenance").textContent="$0",document.getElementById("sum-initial").textContent="$0";return}const t=k(l);document.getElementById("sum-clearing").textContent=`$${i(t.totalClearing)}`,document.getElementById("sum-maintenance").textContent=`$${i(t.totalMaintenance)}`,document.getElementById("sum-initial").textContent=`$${i(t.totalInitial)}`}function R(t,e){const n=l[t];if(!n)return;const a=d.find(r=>r.contractCode===n.contractCode);if(!a)return;const o=h(a,n.price,parseInt(e)||1);l[t]=o,y(),$()}function j(t,e){const n=l[t];if(!n)return;const a=d.find(r=>r.contractCode===n.contractCode);if(!a)return;const o=h(a,parseFloat(e)||0,n.lots);l[t]=o,y(),$()}function f(t,e){const n=document.querySelector(".status-dot"),a=document.getElementById("status-text");if(n&&(n.className=`status-dot ${t}`),a){const o=new Date,r=`${o.getHours().toString().padStart(2,"0")}:${o.getMinutes().toString().padStart(2,"0")}`;a.textContent=`${e} (${r})`}}function L(t){console.log(`
[Test] 測試股票代碼:`,t),t.forEach(e=>{const n=N(d,e);console.log(n?`  ✓ ${e}: ${n.contractName}`:`  ✗ ${e}: 找不到`)})}window.updateLots=R;window.updatePrice=j;document.addEventListener("DOMContentLoaded",async()=>{console.log("=".repeat(60)),console.log("股票期貨保證金查詢系統 v2.0 - TypeScript 模組化版本"),console.log("=".repeat(60)),A(),await F(),L(["2330","2383","6274"]),console.log(`
✓ 應用程式初始化完成！`)});window.testStockCodes=L;
